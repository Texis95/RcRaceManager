    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-3">
            ...
            <div class="btn-group" role="group" aria-label="Cambia vista">
                <button type="button" class="btn btn-outline-primary active" data-view="list" data-section="gare" id="viewListGare">
                    <i class="fas fa-list"></i>
                </button>
                <button type="button" class="btn btn-outline-primary" data-view="grid" data-section="gare" id="viewGridGare">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="gara-row" data-gara-id="<?php echo esc_attr($gara->id); ?>" style="cursor: pointer;">
                            <td>
    ...
    <div id="gridViewGare" class="view-container d-none fade-in">
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm hover-card" data-gara-id="<?php echo esc_attr($gara->id); ?>" style="cursor: pointer;">
                    <div class="card-body">
...
<!-- Modal Dettagli Gara -->
<div class="modal fade" id="modalDettagliGara" tabindex="-1" aria-labelledby="modalDettagliGaraLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalDettagliGaraLabel">Dettagli Gara</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="dettagliGaraContent"></div>
                <hr>
                <h6 class="mb-3">Lista Iscritti</h6>
                <div id="listaIscrittiContent"></div>
            </div>
            <div class="modal-footer">
                <div id="azioniGara" class="w-100 d-flex justify-content-between gap-2">
                    <!-- I pulsanti di azione verranno aggiunti qui dinamicamente -->
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function visualizzaDettagliGara(garaId) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Mostra il modale
                const modal = new bootstrap.Modal(document.getElementById('modalDettagliGara'));
                modal.show();
            } else {
